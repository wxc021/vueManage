<template>
    <div class="tables tables-auto">
        <div class="title text-center">
           <h3 class="text-center wxc-table-style-title">入党申请人情况</h3>
        ...
        <div class="table-outer" style="margin-top: -10px;">
            <table align=center cellspacing=0 cellpadding=0 width="100%">
                <tr>
                    <td  class="justify" style="padding:0 20px;" width="140" colspan=3 rowspan=3>项目</td>
                    <td style="border-right: none;border-bottom: none;" colspan=2></td>
                    <td style="border-right: 2px solid #222;" colspan=9></td>
                </tr>
                <tr>
                    <td  class="justify" style="border-left:none;width:60px; padding: 0 15px;" rowspan=2 colspan=2>总数</td>
                ...
                <tr  v-for="(item, index) in tablesData">
                    ...
                    <td  class="justify br0" width='20' v-if="item.type == 0"></td>
                    <td  class="justify" width='20' v-if="item.type == 0"></td>
                    <td  class="justify" v-if="item.type == 0">{{item.label}}</td>
                    
                    <td  class="justify bb0 br0" width='20' v-if="item.type == 11"></td>
                    <td  class="justify bb0 bl0 br0" width='20' v-if="item.type == 11"></td>
                    <td  class="justify" v-if="item.type == 11">{{item.label}}</td>
                    ...
                    <td v-for="(inner, inx) in item.lists">
                        <input  v-if="inner.disabled"  type="text" :disabled="inner.disabled" :class="{'yellow2': inner.isYellow}" v-model="inner.value" :style="{'color': inner.disabled ? '#111' : inner.class, 'backgroundColor': (index == 0 || index == 3 || index == 2 || index == 11 ) && inner.value != '--' ? '#88e1fe' : (index == 11 || index == 17 || index == 19) && inner.value != '--' ? '#ffce9a' : '' }">
                        <input v-if="!inner.disabled" type="text" :disabled="inner.newDis" :class="{'yellow2': inner.isYellow}" v-model="inner.value" :style="{'color': inner.disabled ? '#111' : inner.class, 'backgroundColor': (index == 0 || index == 3 || index == 2 || index == 11)  && inner.value != '--' ? '#88e1fe' : (index == 10 || index == 17 || index == 19) && inner.value != '--' ? '#ffce9a' : '' }">
                    </td>
		...
		data() {
			return {
                ...
                tablesData: [  
                    ...
                    {type: 1, title: '', label: '六、其它', calc: '', disabled: false, bgcolor: "#222", lists: []},
                ],
                orignData: {},
                lists: [], 
                colors: [],
		...
		methods: {
            ...
            init() {
                ...
                for (let i = 6; i < 10; i++) {
                    ...
                    if (i != 6) {
                        that.tablesData[23].lists[i] = Object.assign(that.tablesData[23].lists[i], {disabled: true, value: '--', originValue: '--'});
                    };
                    if (i != 6 && i != 9) {
                ...
                that.tablesData[19].lists[7] = Object.assign(that.tablesData[19].lists[7], {disabled: true, value: '--', originValue: '--'});
                for (let i = 1; i < 18; i++) {
                    if (i != 3) {
                ...
                for (let i = 7; i < 10; i++) {
                    ...
                    if (i != 9) {
                        ...
                        that.tablesData[6].lists[i] = Object.assign(that.tablesData[6].lists[i], {disabled: true, value: '--', originValue: '--'});
                    };
                };
                
                that.tablesData[14].lists[7] = Object.assign(that.tablesData[14].lists[7], {disabled: true, value: '--', originValue: '--'});
                that.tablesData[15].lists[7] = Object.assign(that.tablesData[15].lists[7], {disabled: true, value: '--', originValue: '--'});
