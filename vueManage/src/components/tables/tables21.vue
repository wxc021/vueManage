    ...
    <div class="tables tables-auto">
        ...
        <div class="table-outer" style="margin-top: -10px;">
            <table align=center cellspacing=0 cellpadding=0 width="100%">
                <tr>
                    <td class="justify" style="padding:0 20px;" width="140" colspan=3 rowspan=2>项目</td>
                ...
                <tr>
                    <td  class="justify" style="border-left:none;width:60px;padding: 0 15px;" colspan=2>总数</td>
                    <td width="60">女</td>
                    <td width="60">少数<br>名族</td>

                    <td width="60">25岁<br>及以下</td>
                    <td width="60">26岁<br>至30岁</td>
                    <td width="60">31岁<br>至35岁</td>
                    <td width="60">36岁<br>至40岁</td>
                    <td width="60">41岁<br>至59岁</td>
                    <td width="60">60岁及<br>以上</td>

                    <td width="60">研究生</td>
                    <td width="60">大学<br>本科</td>
                    <td width="60">大学<br>专科</td>
                    <td width="60">中专</td>
                    <td width="60">高中<br>中技</td>
                    <td width="60">初中及<br>以下</td>
                </tr>
                <tr class="comm-style">
                   <td colspan=3>甲</td> 
                   <td></td>
                ...
                <tr  v-for="(item, index) in tablesData">
                    ...
                    <td  class="justify" v-if="item.type == 11" width="20" style="border-width: 0 0 0 2px;"></td>
		...
		data() {
			return {
                ...
                tablesData: [  
                    ...
                    {type: 11, title: '', label: '二、农牧渔民',  calc: 'let temp = 0;for (let i = 5; i < 15; i++) { let tp = this.origin[17].lists[i].value == "" ? 0 : this.origin[17].lists[i].value; temp += parseInt(tp)};this.origin[17].lists[0].value = temp', disabled: false, bgcolor: "#222", lists: []},
