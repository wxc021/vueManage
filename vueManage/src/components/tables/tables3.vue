<template>
    <div class="tables  tables-auto">
        <div class="title text-center">
           <h3 class="text-center">本年度恢复党籍人员名单</h3>
        ...
        <div class="table-outer"  style="margin-top:-10px;">
            <div class="start-box">
              <table align=center cellspacing=0 cellpadding=0>
                  <tr>
                      <td style="height:130px;width: 160px">姓名</td>
                      <td width="150">性别</td>
                      <td width="150">民族</td>
                      <td width="150">出生年月</td>
                      <td width="300">工作单位及职务</td>
                      <td width="150">入党时间</td>
                      <td width="150">恢复党籍时间</td>
                  </tr>
                  <!--<tr>-->
                     <!--<td height="60">甲</td>-->
                     <!--<td>A</td>-->
                  ...
                  <tr v-for="(item,index) in tablesData1">
                    ...
                    <td width="80" v-for="(inner, inx) in item.lists">
                        <input type="text" :disabled="inner.newDis" :class="{'yellow2': inner.isYellow}" v-model="inner.value" :style="{'color': inner.disabled ? '#111' : inner.class,'backgroundColor': '#ffd4bc'}">
            ...
            <!--<div class="tips-outer start-box">-->
                ...
                <!--<div class="tips box-flex">-->
                    <!--<p>-->
                        <!--1.农村党组织书记培训-->
                        <!--<input type="text" :disabled="footerVal[0].disabled" :style="{color: footerVal[0].class}" v-model="footerVal[0].value" > 人次，社区党务工作者培训-->
                        <!--<input type="text" :disabled="footerVal[1].disabled" :style="{color: footerVal[1].class}" v-model="footerVal[1].value" >人次。国有企业二级及以下单位（部门）党组织书记培训-->
                        <!--<input type="text" :disabled="footerVal[2].disabled" :style="{color: footerVal[2].class}" v-model="footerVal[2].value">次，非公有制经济控制企业党组织书记培训。-->
                        <!--<input type="text" :disabled="footerVal[3].disabled" :style="{color: footerVal[3].class}" v-model="footerVal[3].value">人次。-->
                    <!--</p>-->
                    <!--<p>-->
                        <!--2. 党员年度集中学习培训达标的基层党组织-->
                        <!--<input type="text" :disabled="footerVal[4].disabled" :style="{color: footerVal[4].class}" v-model="footerVal[4].value">个，基层党组织书记和班子成员年度集中学习培训达标的基层党组织-->
                        <!--<input type="text" :disabled="footerVal[5].disabled" :style="{color: footerVal[5].class}" v-model="footerVal[5].value">个。-->
                    <!--</p>-->
                <!--</div>-->
            <!--</div>-->
        </div>
	...
	export default {
		...
		data() {
			return {
                msg: 'this is table',
                tablesData: [
                    {type: 1,title: '', label: '', disabled: false, bgcolor: "#222", lists:[]},
                ],
