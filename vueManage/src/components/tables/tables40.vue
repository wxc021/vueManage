<template>
    <div class="tables tables-auto">
        <div class="title text-center">
           <h3 class="text-center wxc-table-style-title">党的地方委员会换届和领导班子召开民主生活会情况</h3>
        ...
        <div class="table-outer" style="margin-top: -10px;">
            <table align=center cellspacing=0 cellpadding=0>
                  <tr>
                      <td width="210" height="160" rowspan="3" style="height:90px;">项目</td>
                      <td width="90" colspan=2 class="bb0 br0"></td>
                      <td width="120" colspan="2"></td>
                      <td width="60" class="bb0 br0"></td>
                      <td width="60"></td>
                      <td width="60" rowspan="3">本年换届选举代表</td>
                      <td width="60" class="bb0 br0"></td>
                      <td width="60"></td>
                      <td width="60" rowspan="3">党委后补委员</td>
                      <td width="60" class="bb0 br0"></td>
                      <td width="60"></td>
                      <td width="180" colspan="3">召开党委全委会</td>
                      <td width="180" colspan="2" rowspan="2">领导班子召开民主生活会</td>
                  </tr>
                  <tr>
                      <td width="90" colspan="2" rowspan="2" class="bl0">总数</td>
                      <td width="60" class="bb0 br0"></td>
                      <td width="60"></td>
                      <td width="60" rowspan="2">试行党代会常任制的</td>
                      <td width="60" rowspan="2">已召开年会的</td>
                      <td width="60" rowspan="2">党委委员</td>
                      <td width="60" rowspan="2">党委</td>
                      <td width="60" rowspan="2">纪委委员</td>
                      <td width="60" rowspan="2">常委</td>
                      <td width="60" class="bb0 br0"></td>
                      <td width="60"></td>
                      <td width="60" rowspan="2" style="border-right-width:1px;">参加委员</td>

                  </tr>
                  <tr>
                      <td width="60" class="bl0">任届期满</td>
                      <td width="60">本年已换届</td>
                      <td width="60">已召开的</td>
                      <td width="60">召开两次及以上的</td>
                      <td width="60">已召开的</td>
                      <td width="60">参加人员</td>
                  </tr>
                  ...
                  <tr v-for="(item,index) in tablesData">
                    ...
                    <td :class="{'justify': true}"  v-if="item.type == 1">{{item.label}}</td>
                    <td :class="{'justify': true}" v-if="item.type == 2">{{item.label}}</td>
                    ...
                    <td width="60" v-for="(inner, inx) in item.lists" v-if="inx<16" style="height: 100px;">
                        <input  v-if="inner.disabled"  type="text" :disabled="inner.disabled" :class="{'yellow2': inner.isYellow}" v-model="inner.value" :style="{'color': inner.disabled ? '#111' : inner.class, 'backgroundColor': (index == 0) ? '#88e1fe' : '' }">
                        <input v-if="!inner.disabled" type="text" :disabled="inner.newDis" :class="{'yellow2': inner.isYellow}" v-model="inner.value" :style="{'color': inner.disabled ? '#111' : inner.class, 'backgroundColor': (index == 0) ? '#88e1fe' : '' }">
                    </td>
                  </tr>
              </table>
            <div class="tips-outer start-box">
                ...
                <div class="tips box-flex wxc-table-style-footer">
                    <p>
                        本表A1栏中包括建立工委的城市街道
                        <input class="bg-class3" type="text" :disabled="footerVal[0].disabled" :style="{color: footerVal[0].class,'backgroundColor':'#ffce9a'}" v-model="footerVal[0].value">个，   已召开民主生活会的
                        <input class="bg-class3" type="text" :disabled="footerVal[1].disabled" :style="{color: footerVal[1].class,'backgroundColor':'#ffce9a'}" v-model="footerVal[1].value">个，参加人员
                        <input class="bg-class3" type="text" :disabled="footerVal[2].disabled" :style="{color: footerVal[2].class,'backgroundColor':'#ffce9a'}" v-model="footerVal[2].value">名。
                    </p>
                </div>
            </div>
        </div>
	...
	export default {
		...
		data() {
			return {
                msg: 'this is table',
                tablesData: [
                    {type: 1,title: '', label: '单位数', calc: 'for(let i=0;i<16;i++){let tp1=this.origin[1].lists[i].value==""?0:this.origin[1].lists[i].value;let tp2=this.origin[2].lists[i].value==""?0:this.origin[2].lists[i].value;let tp3=this.origin[3].lists[i].value==""?0:this.origin[3].lists[i].value;this.origin[0].lists[i].value=parseInt(tp1)+parseInt(tp2)+parseInt(tp3)}', disabled: false, bgcolor: "#222", lists:[]},
                    {type: 2,title: '', label: '省（区 、市）委', calc: '', disabled: false, bgcolor: "#222", lists:[]},
                    {type: 2,title: '', label: '市（州）委', calc: '', disabled: false, bgcolor: "#222", lists:[]},
                    {type: 2,title: '', label: '县（市、区、旗）委', calc: '', disabled: false, bgcolor: "#222", lists:[]},
