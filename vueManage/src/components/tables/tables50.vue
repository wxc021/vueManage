<template>
    <div class="tables tables-auto">
        <div class="title text-center">
            <h3 class="text-center wxc-table-style-title">社区党建情况</h3>
        ...
        <div class="table-outer" style="margin-top: -10px;">
            <table align=center cellspacing=0 cellpadding=0 width="100%">
                <tr>
                    <td rowspan="4"  width="110">项目</td>
                    <td colspan="12">社区工作者</td>
                    <td colspan="6">经费情况</td>
                    <td colspan="3">办公及活动场所</td>
                    <td rowspan="4">实行大党委的社区</td>
                    <td colspan="2">在职党员到社区报到</td>
                </tr>
                <tr>
                    <td class="justify" style="border-right:none;border-bottom:none;border-left:none;" colspan="2" width="60"></td>
                    <td colspan="6" width=""></td>
                    <td colspan="3" width="">报酬待遇</td>
                    <td rowspan="3" width="40" class="justify">党建工作指导员</td>
                    <td colspan="2" width="">纳入财政预算</td>
                    <td colspan="2" width="">服务群众专项经费</td>
                    <td colspan="2" width="">转移支付、社会赞助、党费支持</td>
                    <td rowspan="3" width="40">暂无办公用房的社区</td>
                    <td rowspan="3" width="40">面积200㎡及以下的社区</td>
                    <td rowspan="3" width="40">面积200㎡及以上的社区</td>
                    <td rowspan="3" width="40">开展在职党员到社区报到为群众服务的社区</td>
                    <td rowspan="3" width="40">到社区报到的在职党员</td>
                </tr>
                <tr>
                    <td rowspan="2" colspan="2" style="border-left:none;">总数</td>
                    <td rowspan="2" width="40" height="260">专职党务工作者</td>
                    <td rowspan="2" width="40" height="260">大专及以上学历</td>
                    <td rowspan="2" width="40" height="260">从机关和街道选派的</td>
                    <td rowspan="2" width="40" height="260">录用为公务员的</td>
                    <td rowspan="2" width="40" height="260">选拔进入事业编制的</td>
                    <td rowspan="2" width="40" height="260">推荐为两代表一委员的</td>
                    <td rowspan="2" width="40" height="260">按不低于上年度当地社会平均工资水平确定报酬的社区</td>

                    <!--<td rowspan="2" width="40" height="260">全部社区工作者年工资总额（万元）</td>-->
                    <!--<td rowspan="2" width="40" height="260">全部社区党组织书记年工资总额（万元）</td>-->

                    <td width="40" style="border-bottom:none;border-right:none;"></td>
                    <td width="40"></td>



                    <td rowspan="2" width="40" height="260">纳入财政预算的社区</td>
                    <td rowspan="2" width="40" height="260">社区纳入财政预算的工作经费总额（万元）</td>
                    <td rowspan="2" width="40" height="260">建立服务群众专项经费的社区</td>
                    <td rowspan="2" width="40" height="260">社区全年服务群众专项经费总额（万元））</td>
                    <td rowspan="2" width="40" height="260">有转移支付、社会赞助、党费支持的社区）</td>
                    <td style="border-right-width:1px;" rowspan="2" width="40" height="260">社区全年转移支付、社会赞助、党费支持总额（万元</td>
                </tr>
                <tr>
                    <td  width="40" height="260" style="border-left:none;">全部社区工作者年工资总额（万元）</td>
                    <td style="border-right-width:1px;" width="40" height="260">全部社区党组织书记年工资总额（万元）</td>
                </tr>
                <tr class="comm-style">
                    <td height="30">甲</td>
                    <td colspan="2">A</td>
                ...
                <tr  v-for="(item, index) in tablesData">
                    ...
                    <td :class="{'justify': true}" v-if="item.type == 1" width="40">{{item.label}}</td>

                    <td class="comm-reset" width="20">{{index+1}}</td>

                    <td v-for="(inner, inx) in item.lists" width="40">
                        <input  v-if="inner.disabled"  type="text" :disabled="inner.disabled" :class="{'yellow2': inner.isYellow}" v-model="inner.value" :style="{'color': inner.disabled ? '#111' : inner.class, 'backgroundColor': (index == 0) ? '#88e1fe' :  '#ffce9a'  }">
                        <input v-if="!inner.disabled" type="text" :disabled="inner.newDis" :class="{'yellow2': inner.isYellow}" v-model="inner.value" :style="{'color': inner.disabled ? '#111' : inner.class, 'backgroundColor': (index == 0) ? '#88e1fe' :  '#ffce9a'  }">
                    </td>

                </tr>
            </table>
            <div class="tips-outer start-box">
                <p class="wxc-table-style-footer">补充资料：</p>
                <div class="tips box-flex">
                    <p class="wxc-table-style-footer">实行大工委的街道
    ...
    export default {
        ...
        data() {
            return {
                msg: 'this is table',
                tablesData: [
                    {type: 1,title: '',label: '总计',calc:'for(let i=0;i<23;i++){let tp1=this.origin[1].lists[i].value==""?0:this.origin[1].lists[i].value;let tp2=this.origin[2].lists[i].value==""?0:this.origin[2].lists[i].value;this.origin[0].lists[i].value=parseInt(tp1)+parseInt(tp2)}',disabled: false,bgcolor: "#222",lists: []},
                    {type: 1,title: '',label: '城市社区',calc:'',disabled: false,bgcolor: "#222",lists: []},
                    {type: 1,title: '',label: '乡镇社区',calc:'',disabled: false,bgcolor: "#222",lists: []},
...
//                    that.footerVal[0].value = parseInt(tp1) + parseInt(tp2) + parseInt(tp3);
//                    that.footerVal[4].value = parseInt(tp5) + parseInt(tp6) + parseInt(tp7);
