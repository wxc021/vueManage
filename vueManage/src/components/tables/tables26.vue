<template>
    <div class="tables tables-auto">
        <div class="title text-center">
           <h3 class="text-center wxc-table-style-title">入党积极分子情况</h3>
        ...
        <div class="table-outer" style="margin-top: -10px;">
            <table align=center cellspacing=0 cellpadding=0 width="100%">
                <tr>
                    <td style="padding:0 20px;" class="justify" width="140" colspan=3 rowspan=3>项目</td>
		...
		data() {
			return {
                ...
                tablesData: [  
                    ...
                    {type: 5, title: '', label: '工勤技能人员', calc: '', disabled: false, bgcolor: "#222", lists: []},
                    {type: 6, title: '', label: '农民工',  calc: '', disabled: false, bgcolor: "#222", lists: []},
                    {type: 11, title: '', label: '二、农牧渔民',  calc: '', disabled: false, bgcolor: "#222", lists: []},
