<template>
    <div class="tables  tables-auto">
        <div class="title text-center">
           <h3 class="text-center wxc-table-style-title">党内表彰情况</h3>
        ...
        <div class="table-outer"  style="margin-top:-10px;">
            <div class="start-box">
              <table align=center cellspacing=0 cellpadding=0>
                  <tr>
                      <td width="360" rowspan=3 style="height:48px;">项目</td>
                      <td width="360" class="bb0 br0" colspan="2" style="height:22px;"></td>
                      <td style="height:22px;"></td>
                      <td colspan="4">表彰层级</td>
                      <td colspan="11">受表彰的党员或党组织所在单位</td>
                  </tr>
                  <tr>
                      <td width="140" colspan=2 rowspan=2 class="bl0">总数</td>
                      <td rowspan="2">抗震救灾</td>
                      <td rowspan="2">省（区、市）一级表彰</td>
                      <td rowspan="2" class="" width="60">市（地、州、盟）一级表彰</td>
                      <td rowspan="2" class="" width="60">县（市、区、旗）一级表彰</td>
                      <td rowspan="2" width="60">其他表彰</td>

                      <td rowspan="2" width="60">机关</td>
                      <td rowspan="2" width="60">事业单位</td>
                      <td colspan="3" width="60">企业</td>
                      <td rowspan="2" width="60">社会组织</td>
                      <td rowspan="2" width="60">街道</td>
                      <td rowspan="2" width="60">乡镇</td>
                      <td rowspan="2" width="60">社区</td>
                      <td rowspan="2" width="60">建制村</td>
                      <td rowspan="2" width="60">其他</td>
                  </tr>
                  <tr>
                      <td width="60" class="bl0">国有经济控制</td>
                      <td width="60">集体经济控制</td>
                      <td width="60" style="border-right: 1px solid #222;">非公有经济控制</td>
                  </tr>
                  <tr class="comm-style">
                     <td height="36">甲</td>
                     <td colspan=2>A</td>
                  ...
                  <tr v-for="(item,index) in tablesData1">
                    ...
                    <td width="80" v-for="(inner, inx) in item.lists">
                        <input type="text" :disabled="inner.newDis" :class="{'yellow2': inner.isYellow}" v-model="inner.value" :style="{'color': inner.disabled ? '#111' : inner.class, 'backgroundColor': (inx == 0) ? '#88e1fe' : (index == 0 && inx == 1) ? '#ffce9a' : '' }">
                    </td>
            ...
            <div class="tips-outer start-box">
                ...
                <div class="tips box-flex wxc-table-style-footer">
                    <p>1.本年度表彰的优秀共产党员中有党委（总支部、支部）书记<input type="text" :disabled="footerVal[0].disabled" :style="{color: footerVal[0].class}" v-model="footerVal[0].value" >名； 表彰的优秀党务工作者中有党委（总支部、支部）书记<input type="text" :disabled="footerVal[1].disabled" :style="{color: footerVal[1].class}" v-model="footerVal[1].value" >名。</p>
            
                    <p>2.本年度表彰的优秀共产党员中生活困难的<input type="text" :disabled="footerVal[2].disabled" :style="{color: footerVal[2].class,'backgroundColor':'#ffce9a'}" v-model="footerVal[2].value">名；表彰的优秀党务工作者中生活困难的<input type="text" :disabled="footerVal[3].disabled" :style="{color: footerVal[3].class,'backgroundColor':'#ffce9a'}" v-model="footerVal[3].value">名。</p>
            
                    <p>3.本年度追授优秀共产党员<input type="text" :disabled="true" :style="{color: footerVal[4].class,'backgroundColor':'#ffce9a'}" v-model="footerVal[4].value">名，其中抗灾救灾追授<input type="text" :disabled="true" :style="{color: footerVal[5].class,'backgroundColor':'#ffce9a'}" v-model="footerVal[5].value">名。</p>
                </div>
            </div>
        </div>
	...
	export default {
		...
		data() {
			return {
                msg: 'this is table',
                tablesData: [
                    {type: 1,title: '', label: '先进基层党组织', calc: '',lists:[], bgcolor: "#222",},
                    {type: 1,title: '', label: '优秀共产党员', calc: '',lists:[], bgcolor: "#222",},
                    {type: 1,title: '', label: '优秀党务工作者', calc: '',lists:[], bgcolor: "#222",},
                ],
