<template>
    <div class="tables  tables-auto">
        <div class="title text-center">
           <h3 class="text-center wxc-table-style-title">党员培训情况</h3>
           <p>起止时间：2016年1月1日至2016年12月31日</p>
        </div>

        <div class="start-box box-pack" style="position: relative; top: -16px;">
            <p class="wxc-table-style-name">填报单位：天房科技党总支</p>
            <p style="text-align: right;">第九表</p>
        </div>
        <div class="table-outer"  style="margin-top:-10px;">
            ...
            <div class="start-box">
              <table align=center cellspacing=0 cellpadding=0>
                  <tr>
                      <td style="height:130px;width: 160px padding: 0 ">项目</td>
                      <td style="padding:0 20px;" width="130">总数</td>
                      <td style="padding:0 20px;" width="130">基层党组织书记培训</td>
                      <td style="padding:0 20px;" width="130">农村党员远程教育培训</td>
                      <td style="padding:0 20px;" width="130">非公有制经济组织和社会组织党员培训</td>
                      <td style="padding:0 20px;" width="130">新党员培训</td>
                      <td style="padding:0 20px;" width="130">流动党员培训</td>
                      <td style="padding:0 20px;" width="130">边疆民族地区基层党员教育培训</td>
                      <td style="padding:0 20px;" width="130">党员创业就业技能培训</td>
                  </tr>
                  <tr class="comm-style">
                     <td height="60">甲</td>
                     <td>A</td>
                  ...
                  <tr v-for="(item,index) in tablesData1">
                    <td width="30">人次</td>
                    <td width="80" style="height:120px;" v-for="(inner, inx) in item.lists">
                        <input type="text" :disabled="inner.newDis" :class="{'yellow2': inner.isYellow}" v-model="inner.value" :style="{'color': inner.disabled ? '#111' : inner.class,'backgroundColor':'#ffce9a' }">
            ...
            <div class="tips-outer start-box">
                ...
                <div class="tips box-flex wxc-table-style-footer">
                    <p>
                        1.农村党组织书记培训
                        <input type="text" :disabled="footerVal[0].disabled" :style="{color: footerVal[0].class,'backgroundColor':'#ffce9a'}" v-model="footerVal[0].value" > 人次，社区党务工作者培训
                        <input type="text" :disabled="footerVal[1].disabled" :style="{color: footerVal[1].class,'backgroundColor':'#ffce9a'}" v-model="footerVal[1].value" >人次。国有企业二级及以下单位（部门）党组织书记培训
                        <input type="text" :disabled="footerVal[2].disabled" :style="{color: footerVal[2].class,'backgroundColor':'#ffce9a'}" v-model="footerVal[2].value">次，非公有制经济控制企业党组织书记培训。
                        <input type="text" :disabled="footerVal[3].disabled" :style="{color: footerVal[3].class,'backgroundColor':'#ffce9a'}" v-model="footerVal[3].value">人次。
                    </p>
                    <p>
                        2. 党员年度集中学习培训达标的基层党组织
                        <input type="text" :disabled="footerVal[4].disabled" :style="{color: footerVal[4].class,'backgroundColor':'#ffce9a'}" v-model="footerVal[4].value">个，基层党组织书记和班子成员年度集中学习培训达标的基层党组织
                        <input type="text" :disabled="footerVal[5].disabled" :style="{color: footerVal[5].class,'backgroundColor':'#ffce9a'}" v-model="footerVal[5].value">个。
                    </p>
                </div>
            </div>
        </div>
	...
	export default {
		...
		data() {
			return {
                msg: 'this is table',
                tablesData: [
                    {type: 1,title: '', label: '总计', disabled: false, bgcolor: "#222", lists:[{disabled: false,value: 4},{disabled: false,value:7},{disabled: false,value:67},{disabled: false,value:3},{disabled: false,value:3},{disabled: false,value:3}]},
                ],
