<template>
    <div class="">
<Modal v-model="modal1" title="转为正式党员征求群众意见会议记录" width="800" @on-ok="ok" @on-cancel="cancel">
    <div class="onlinetable-wrap">
        <h1><span>{{table.A1}}</span>转为正式党员征求群众意见会议记录</h1>
        <div class="page-header">党组织名称：<input <input v-model="table.B3" type="text" :style="{width: '500px',height:'50px'}"/></div>
        <table class="table1">
            <tr>
                <td width='100'>时间</td>
