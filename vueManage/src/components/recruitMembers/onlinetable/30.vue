                ...
                <table class="table1">
                    <tr>
                        ...
                        <td colspan="3":style="{ 'text-align':'right' }">
                            <input v-model="table.B3" type="text" :style="{width: '80px', display : 'inline-block', 'text-align':'right'}">党委第
                    ...
                    <tr>
                        <td>列席人：</td>
                        <td colspan="3"><input v-model="table.B8" type="text"></td>
                    </tr>
                    <tr>
...
<script>
    export default {
        ...
        watch: {
            ...
            branchname(val){
                this.table.B3 = val + '党委第' + this.times + '次会议';
            },
            times(val){
                this.table.B3 = this.branchname + '党委第' + val  + '次会议';
            },
            names(val){
