    ...
    <div>
      <Modal
          ...
          <div class="onlinetable-wrap">
              ...
              <table class="table1">
                  <!--<tr>-->
                      <!--<td colspan="4" :style="{ 'text-align' : 'left','border-bottom':'none' }">{{ table.A3 }}</td>-->
                  <!--</tr>-->
                  <tr>
                      <td>党组织名称:</td>
                      <td colspan="3" :style="{ 'text-align' : 'left' }"><input type="text" v-model="table.A3"></td>
                  </tr>
                  <tr>
                      <td>时  间：</td>
                  ...
                  <tr>
                      <td colspan="4">
                          <textarea v-model="table.A10" rows="10" :style="{'width': '100%'}"></textarea>
                      </td>
                  </tr>
              </table>
          </div>
