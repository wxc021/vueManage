<template>
    <div class="">
<Modal v-model="modal1" title="党委会会议纪录" width="800" @on-ok="ok" @on-cancel="cancel">
    <div class="onlinetable-wrap">
        <h1>党委会会议纪录</h1>
        <div class="page-header text-center">
            <input class="text-center" v-model="table.A3" type="text" :style="{width: '60px',height:'50px'}"/>年
            <input class="text-center" v-model="table.B3" type="text" :style="{width: '60px',height:'50px'}"/>党委第
