    ...
    <table class="drag-table">
        ...
        <draggable element="tbody" :options="dragOption" v-model="lists">
            <tr v-for="(item, index) in lists">
                ...
                <td>{{ item.is_front }}</td>
                <td>{{ item.is_migrant_worker==2? '否' : '是' }}</td>
...
import add from '../pop/partymember/memberinfo-post-add.vue';
export default {
...
.drag-table tbody tr.drag:hover {
...
.drag-table tbody td.ready {
    color: #d73826
}

.drag-table tbody td.out {
    color: #f07100
}

.drag-table tbody td.in {
    color: #008df0
}
</style>