    ...
    <transition name="slide">
        <div  v-if="isshow" class="aside">
            ...
            <div class="aside-body">
                <component ref="asidebody" style="height: 100%;" @change-aside-title="changeTitle" :is="currentView" :viewdata="currentViewData"></component>
            </div>
        </div>
    </transition>
</template>
        ...
        methods: {
            close(){
                ...
                if (/checkForm/.test(this.$route.matched[0])) {
                    ...
                    console.log(this.$store.state.isComQuery);
                    //if(this.$store.state)
                    this.$router.push({ 
