                ...
                <div class="layout-content" style="position:realtive;">
                    <div class="content-padding">
                        ...
                        <div class="start-box" style="border:0px solid #ddd;height: calc(100% - 100px);margin-top:20px;background:#fff;">
                            <div class="" style="width:382px;height: 100%;overflow: auto;">
                                <Table ref="membertable" :highlight-row="true" @on-row-click="onTableSelect" style="height: 100%;overflow: auto;" :no-data-text="tableTxt"  border :columns="tableModel" :data="lists"></Table>
                            </div>
...
//            },
        ...
        methods: {
            ...
            changeStep(value){
                ...
                let _this = this;
                let qs = require('qs');
                this.step_pid=value[value.length-1];
